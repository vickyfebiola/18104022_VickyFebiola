<?php 
    ...
    $kelas = ['SE-02-A', 'SE-02-B', 'SE-02-C']; // untuk pilihan kelas
    $sql = 'SELECT * FROM data';    // mengambil data dari tabel data
    $data = $conn->query($sql); // untuk mengirim / koenski query sql
?>
<!-- tampilan web form mahasiswa -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Link rel untuk Bootstrap CSS -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                <h4>Input Data</h4>
                <!-- form action akan disimpan pada file simpan.php dengan method post -->
