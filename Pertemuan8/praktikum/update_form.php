<?php
    ...
    // untuk menyambungkan ke database dan menjalankan perintah sql
    $data = $conn->query($sql);
    // sql untuk menampilkan data, diambil berdasarkan id dengan menangkap data id menggunakan method get 
    $sql_mahasiswa = "SELECT * FROM data WHERE id=".$_GET['mahasiswa_id'];
    // untuk menyambungkan database dan menjalankan perintah sql
